			...
			<el-main style="padding:30px;">
				<div class="colonn">
					<div style="padding:20px;" class="background1">
						<el-steps :active="selIndex" align-center style="background-color: #ffffff;">
					...
					<div class="roww rowsb background1" style="justify-content: space-between;
    padding: 10px;
    margin: 0 20px 0 20px;
    background-color: white;">
						<el-button type="primary" @click="xiayibuClick(2)">上一步</el-button>
						<el-button type="primary" @click="xiayibuClick(1)">下一步</el-button>
					</div>
				</div>
...
const paths=ref(['/addPaper/addPaperone', '/addPaper/addPapertwo', '/addPaper/addPaperthree', '/addPaper/addPaperfour'])

		const onChange =(index:string)=> { // 父组件获取切换后的选中步骤
