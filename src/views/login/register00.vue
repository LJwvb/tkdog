      ...
      <el-form :model="ruleForm" ref="ruleFormRef" :rules="rules" label-width="80px" label-position="left">
        ...
        <el-form-item label="头像" prop="avatar">
          <!--
           ...
           -->
          <el-upload class="avatar-uploader" :action="uploadUrl" :data="uploadObj" :show-file-list="false"
        ...
        <el-row>
          ...
          <el-col :span="7" style="margin-left: 10px">
            <!-- <img :src="registerCaptcha" alt="" style="width: 100%; height: 40px" @click="changeRegisterCaptcha" /> -->
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="16">
          ...
          <el-col :span="7" style="margin-left: 10px">
            <el-button style="width: 150px" @click="getRcode">获取用户验证码</el-button>
          </el-col>
        </el-row>
      </el-form>
...
const getRcode = async () => {
  let count = 0;
  ruleFormRef.value.validateField(['phone', 'code'], (errorMessage: Error) => {
    if (!errorMessage) {
      count++;
    }
  });
...
const handleRegister = async () => {
  ruleFormRef.value.validate(async (valid: boolean) => {
    ...
    const res: any = await register(ruleFormRef);
    if (res.code === 200) {
      // 成功
