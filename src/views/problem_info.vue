								...
								<div class="colonn">
									<div class="rowsb border_bottom background1 center_center" style="padding:20px;">
										<div class="roww center_center">
											...
											<div class="huanhang">
												<div class="biaoqian2" style="background-color: rgb(0, 175, 155);color: white;">最新</div>
									...
									<div class="border_bottom background1 colonn" style="padding:20px; align-items: flex-start;">
										<div>在关系代数中，对一个关系做投影操作后，新关系的元组个数（ ）原来关系的元组个数。</div>
										<div class="colonn">
									...
									<div class="colonn background1" style="padding: 0px 20px 20px 20px;align-items: flex-start;">
										<div style="font-weight: bold;padding: 20px 0px 20px 0px;">解析</div>
									...
									<div class="roww background1 center_center"
										style="padding:10px 20px 10px 20px;color: #999999;border-top:1px solid #f5f5f5; ">
										<div class="roww  center_center">
										...
										<div class="line2"></div>
										<div class="roww  center_center">
											<el-button style="color: #999999;" class="el-icon-s-goods" type="text">点赞
											</el-button>
										</div>
						...
						<div class="grid-content colonn ">
							<el-card style="margin-bottom:10px ">
								<div class="colonn border_bottom background1" style="margin-bottom: 30px;">
									<div class="border_bottom" style="padding:20px;">題目信息</div>
							...
							<el-card style="margin-bottom:10px ">
								<div class="colonn border_bottom background1">
									<div class="border_bottom" style="padding:20px;">相似题目</div>
